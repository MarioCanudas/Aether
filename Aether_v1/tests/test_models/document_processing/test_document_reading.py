...
class TestPDFReaderValidation:
    ...
    def pdf_reader_from_path(self, get_file_from_path) -> PDFReader:
        return PDFReader(get_file_from_path)
        
    @pytest.fixture(scope= 'class')
    def pdf_reader_from_bytesio(self, get_bytesio_from_path) -> PDFReader:
        return PDFReader(get_bytesio_from_path)
    
    @pytest.mark.parametrize('get_file_from_path', [SMALL_FILE], indirect=True)
    def test_is_path_with_valid_pdf_path(self, pdf_reader_from_path):
        """Test _is_path method with valid PDF path"""
        pdf_reader: PDFReader = pdf_reader_from_path
...
class TestPDFReaderMetadata:
    ...
    @pytest.mark.parametrize('get_file_from_path', [SMALL_FILE], indirect=True)
    def test_get_height_with_path(self, pdf_reader_from_path):
    ...
    @pytest.mark.parametrize('get_bytesio_from_path', [SMALL_FILE], indirect=True)
    def test_get_height_with_bytesio(self, pdf_reader_from_bytesio):
    ...
    @pytest.mark.parametrize('get_file_from_path', [SMALL_FILE], indirect=True)
    def test_get_width_with_path(self, pdf_reader_from_path):
    ...
    @pytest.mark.parametrize('get_bytesio_from_path', [SMALL_FILE], indirect=True)
    def test_get_width_with_bytesio(self, pdf_reader_from_bytesio):
    ...
    def test_metadata_consistency(self, pdf_reader_from_path, pdf_reader_from_bytesio):
        """Test that metadata is consistent between path and BytesIO initialization"""
        pdf_reader_path: PDFReader = pdf_reader_from_path
        pdf_reader_bytes: PDFReader = pdf_reader_from_bytesio
...
class TestPDFReaderWordExtraction:
    ...
    @pytest.mark.parametrize('get_file_from_path', [SMALL_FILE], indirect=True)
    def test_extract_words_basic(self, pdf_reader_from_path):
    ...
    @pytest.mark.parametrize('get_file_from_path', [SMALL_FILE], indirect=True)
    def test_extract_words_data_types(self, pdf_reader_from_path):
    ...
    @pytest.mark.parametrize('get_bytesio_from_path', [SMALL_FILE], indirect=True)
    def test_extract_words_with_bytesio(self, pdf_reader_from_bytesio):
    ...
    @pytest.mark.parametrize('get_file_from_path', [SMALL_FILE], indirect=True)
    def test_extract_words_caching(self, pdf_reader_from_path):
    ...
    def test_extract_words_consistency(self, pdf_reader_from_path, pdf_reader_from_bytesio):
