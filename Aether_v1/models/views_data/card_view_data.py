...
class CardViewData(BaseModel):
    ...
    @classmethod
    def validate_income_vs_expenses_chart(
        cls, income_vs_expenses_chart: Chart | None
    ) -> Chart | None:
        if (income_vs_expenses_chart is not None) and not isinstance(
            income_vs_expenses_chart, Chart
        ):
